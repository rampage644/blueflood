...
public class HttpEventsHandlerTest {
    ...
    private HttpRequest createGetRequest(String requestQuery) {
        return createRequest(HttpMethod.GET, requestQuery);
    }

    private HttpRequest createRequest(HttpMethod method, String requestBody) {
        DefaultHttpRequest rawRequest = new DefaultHttpRequest(HttpVersion.HTTP_1_1, method, "/v2.0/" + TENANT + "/events");
