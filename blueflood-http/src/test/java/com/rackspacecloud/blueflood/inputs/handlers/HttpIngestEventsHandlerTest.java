...
public class HttpIngestEventsHandlerTest {

    private GenericElasticSearchIO searchIO;
    private HttpIngestEventsHandler handler;
    private ChannelHandlerContext context;
    private Channel channel;
    private static final String TENANT = "tenant";

    public HttpIngestEventsHandlerTest() {
        searchIO = mock(GenericElasticSearchIO.class);
        handler = new HttpIngestEventsHandler(searchIO);
